...
<body class="bg-gray-50 flex h-screen overflow-hidden text-gray-800 font-sans">
    ...
    <!-- Chatbot Widget -->
    <div id="chatbot-widget" class="fixed bottom-4 right-4 w-96 h-96 bg-white rounded-lg shadow-2xl border border-gray-200 flex flex-col hidden z-50">
        <!-- Chatbot Header -->
        <div class="bg-blue-600 text-white p-4 rounded-t-lg flex justify-between items-center">
            <div class="flex items-center">
                <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                <span class="font-semibold">Dashboard Assistant</span>
            </div>
            <button onclick="toggleChatbot()" class="text-white hover:bg-blue-700 p-1 rounded">
        ...
        <div id="chat-messages" class="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50">
            <div class="flex justify-start">
                <div class="bg-blue-100 text-blue-900 p-3 rounded-lg max-w-xs text-sm">
                    👋 Hi! I can help you with dashboard information, data queries, and reports. Try asking me something!
                </div>
            </div>
        </div>
    ...
    <button onclick="toggleChatbot()" id="chatbot-button" class="fixed bottom-4 right-4 bg-blue-600 text-white rounded-full p-4 shadow-lg hover:bg-blue-700 transition z-40">
